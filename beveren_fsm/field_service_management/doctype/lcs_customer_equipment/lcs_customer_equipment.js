frappe.ui.form.on("LCS Customer Equipment", {
    ...
    refresh: function(frm) {
        ...
        if (frm.doc.paired_component) {
            frm.add_custom_button(frm.doc.paired_component, function() {
                frappe.set_route("Form", "LCS Customer Equipment", frm.doc.paired_component);
            }, "Paired Record");
        }
    },
    ...
    base_scale_model: function(frm) {
        ...
        frappe.db.get_doc("LCS Scale Model", frm.doc.base_scale_model).then(doc => {
            const cu = doc.capacity_unit || "";
